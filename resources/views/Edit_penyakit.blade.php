                                            ...
                                            <form action="{{ url('/penyakit/update') }}" method="post">
                                                ...
                                                <div class="card-body card-block">
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <select name="kategori" class="form-control">
                                                                ...
                                                                <option value="{{ $dataKategori->id }}" <?php if($data->id_kategori == $dataKategori->id){?> selected="selected" <?php }?>>{{ $dataKategori->nama }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <textarea name="penyebab" id="penyebab" class="form-control">{{ $data->penyebab }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col col-md-3">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <textarea name="gejala" id="gejala" class="form-control">{{ $data->gejala }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col col-md-3">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <textarea name="pengobatan" id="pengobatan" class="form-control">{{ $data->pengobatan }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col col-md-3">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <textarea name="pencegahan" id="pencegahan" class="form-control">{{ $data->pencegahan }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
